...
public class RenderProxy {
	...
	private static void getViewTrans(AffineTrans a, float[] out) {
		...
		out[4] = a.m01 * MathUtil.TO_FLOAT;
		out[5] = a.m11 * MathUtil.TO_FLOAT;
		out[6] = a.m21 * MathUtil.TO_FLOAT;
		out[7] = 0;

		out[8] = a.m02 * MathUtil.TO_FLOAT;
		out[9] = a.m12 * MathUtil.TO_FLOAT;
		out[10] = a.m22 * MathUtil.TO_FLOAT;
		out[11] = 0;
