...
public class Image extends com.siemens.mp.misc.NativeMem {
	...
	public static javax.microedition.lcdui.Image createTransparentImageFromMask(javax.microedition.lcdui.Image image, javax.microedition.lcdui.Image mask) {
		...
		javax.microedition.lcdui.Image ret = javax.microedition.lcdui.Image.createRGBImage(imagePixels, width, height, true);
		ret.setHasSiemensAlpha(true);
		return ret;
	}
	...
	public static void mirrorImageHorizontally(javax.microedition.lcdui.Image image) {
		javax.microedition.lcdui.Image mirrored = javax.microedition.lcdui.Image.createImage(image, 0, 0, image.getWidth(), image.getHeight(), javax.microedition.lcdui.game.Sprite.TRANS_MIRROR);
		((pl.zb3.freej2me.bridge.graphics.CanvasImage)image).setFrom(mirrored);
	}

	public static void mirrorImageVertically(javax.microedition.lcdui.Image image) {
		javax.microedition.lcdui.Image mirrored = javax.microedition.lcdui.Image.createImage(image, 0, 0, image.getWidth(), image.getHeight(), javax.microedition.lcdui.game.Sprite.TRANS_MIRROR_ROT180);
		((pl.zb3.freej2me.bridge.graphics.CanvasImage)image).setFrom(mirrored);
	}
